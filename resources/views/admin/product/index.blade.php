            ...
            <table class="table table-hover align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        <th class="ps-4 min-w-325px rounded-start">المنتج</th>
                        <th class="ps-4 min-w-325px rounded-start">تفاصيل</th>
                        ...
                        <td class="px-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('product.edit', $p->id) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$p->name}}</a>
                                </div>
                            </div>
                        </td>
                        <td class="px-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$p->des}}</a>
                        </td>
