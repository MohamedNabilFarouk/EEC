 ...
 <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
     ...
     <div class="aside-logo flex-column-auto" id="kt_aside_logo" style="height: 120px;">
         ...
         <a href="#" class="m-auto">
            <h3>EEC group</h3>
            {{-- <img alt="Logo" src="" class=" logo" alt="Logo" style="height: 100px;width: 100%;" /> --}}
         </a>
         <!--end::Logo-->
         <!--begin::Aside toggler-->
     ...
     <div class="aside-menu flex-column-fluid">
         ...
         <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 <div class="menu-item">
                     <a class="menu-link active" href="{{ route('Allproducts') }}">
                         ...
                         <span class="menu-title"> جميع المنتجات - الرئيسية</span>
                     </a>
                 </div>
                 <div class="menu-item">
                     ...
                     <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                         ...
                         <div class="menu-sub menu-sub-accordion menu-active-bg">
                             <div class="menu-item">
                                 <a class="menu-link" href="{{ route('Allproducts') }}">
                                     <span class="menu-bullet">
                                         <span class="bullet bullet-dot"></span>
                                     </span>
                                     <span class="menu-title">البحث</span>
                                 </a>
                             </div>
                 ...
                 <!-- pharmacy -->
                 <div class="menu-item">
                     <a class="menu-link" href="{{ url('pharmacy') }}">
                         <span class="menu-icon">
                             <!--begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg-->
                             <span class="svg-icon svg-icon-2">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                         ...
                         <span class="menu-title">الصيدليات</span>
                     </a>
                 </div>
                <!--end pahrmacy  -->
